...
export const load: PageServerLoad = async (event) => {
	...
	const [mapsResult, rotationsResult, tsushimaMapsResult, tsushimaRotationsResult] = await Promise.all([
	...
	if (tsushimaMapsResult.error) console.error('Error fetching tsushima_maps:', tsushimaMapsResult.error);
